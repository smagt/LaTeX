...
So, write ``the two-dimensional manifold'' since ``the two dimensional manifolds'' would mean something else (though I would not know what a ``dimensional manifold'' is).  And ignore my previous comment on ``light-weight'' vs.\ ``lightweight'', as I was blatantly wrong there.
