...
\footnotesize{version 3.16227766016837}}
...
\section{Language}
Now, English is a very weird European language, since it is totally eclectic.  Built from various sources.  
Germanic (Anglo-Saxon, 450–1100 AD) — the core grammatical structure and most common words (water, hand, house, eat). Then old Norse (800–1100 AD) — via Viking settlement and the Danelaw; contributed a surprisingly large share of everyday vocabulary, including sky, egg, knife, leg, window, get, give, take, want, and crucially the third-person plural pronouns they/them/their (which replaced the Old English forms). And finally
Norman French (1066–1500 AD) — via the Conquest; brought legal, governmental, culinary, and aristocratic vocabulary. And we're ignoring Latin here which came in waves related to contact with the romans, early on; christianisation; and in the renaissance of course. Don't trust me, instead refer to scholars, such as the very entertaining sources by David Crystal. Let me get back on track.
